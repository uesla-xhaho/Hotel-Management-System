...
#grid{
     display: grid;
     margin-top: 70px;
      grid-template-columns: 350px  350px; /* Two columns with equal width */
      grid-template-rows: 200px  200px; /* Two rows with equal height */
          ...
          <div class="card board1 fill">
              <div class="card-body">
                  <div class="dash-widget-header">
                      <div>
                          <h3 class="card_widget_header">{{ $bookingCount }}</h3>
      ...
      <div class="col-xl-3 col-sm-6 col-12">
          <div class="card board1 fill">
              <div class="card-body">
                  <div class="dash-widget-header">
                      <div>
                          <h3 class="card_widget_header">{{ $roomCount }}</h3>
          ...
          <div class="card board1 fill">
              <div class="card-body">
                  <div class="dash-widget-header">
                      <div>
                          <h3 class="card_widget_header">{{ $customerCount }}</h3>
          ...
          <div class="card-header d-flex justify-content-between align-items-center">
              ...
              <div class="card-body">
                  <div class="table-responsive" style=" text-align: center;">
                      @component('layouts.data-table', ['id' => 'user-home-bookings'])
                          <thead>
                              <tr>
