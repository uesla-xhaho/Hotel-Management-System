...
<div class="container" id="register-container">
    <div class="row justify-content-center">
        <div class="col-md-8">
                    ...
                    <form method="POST" action="{{ route('bookingadd') }}" enctype="multipart/form-data" data-hm-refresh="#nav-home, #nav-profile, #nav-contact" data-hm-reset="true">
                        ...
                        <div class="row mb-3">
                            <label for="customer_id" class="col-md-4 col-form-label text-md-end">{{ __('Customer Name:') }}</label>
                            <div class="col-md-6">
                            <select name="customer_id" class="form-select" id="select">
  ...
  <main class="content">
<div class="divtable">
@component('layouts.data-table', ['cookieKey' => 'user-booking-pending'])
  <thead>
      <tr>
      ...
      @foreach($pending as $row)
        ...
        <div class="dropdown justify-content-center align-items-center">
          ...
          <div class="dropdown-content" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="{{ route('choose-room',$booking_id= $row['id']) }}"><i class="fa-solid fa-bed" style="margin-right:3px;"></i>Choose Room</a>
  ...
  @component('layouts.data-table', ['cookieKey' => 'user-booking-active'])
    <thead>
        <tr>
          <th class="text-center">Booking ID</th> 
          <th class="text-center">Customer Name</th>
      ...
      <div class="dropdown justify-content-center align-items-center">
        ...
        <a class="dropdown-item" href="{{ route('choose-room', $booking_id = $row['id']) }}"><i class="fa-solid fa-bed"  style="margin-right:3px;"></i> Change Room</a>
        <a class="dropdown-item" href="{{ route('booking4', $id = $row['id']) }}"><i class="fa-solid fa-xmark" style="margin-right:3px;"></i>Cancel</a>
        </div>
      </div>
    </td>
  ...
  <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
            @component('layouts.data-table', ['cookieKey' => 'user-booking-cancelled'])
                  <thead>
                    <tr>
                    <th class="text-center">Booking ID</th> 
                    <th class="text-center">Customer Name</th>
