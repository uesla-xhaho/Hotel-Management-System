...
<div class="sidebar-menu">
    ...
    <div class="nav-items">
            ...
            <a class="nav-item" href="{{ route('user-home') }}">
                <i class="fas fa-home"></i>
                <span class="ms-1 d-none d-sm-inline">Home</span>
            </a>
            <a class="nav-item" href="{{ route('user-rooms') }}">
                <i class="fa-solid fa-bed"></i>
                <span class="ms-1 d-none d-sm-inline">Rooms</span>
            </a>
            <a class="nav-item" href="{{ route('user-booking') }}">
                <i class="fa-solid fa-calendar"></i>
                <span class="ms-1 d-none d-sm-inline">Bookings</span>
            </a>
            <a class="nav-item" href="{{ route('user-customer') }}">
                <i class="fa-solid fa-person"></i>
                <span class="ms-1 d-none d-sm-inline">Customers</span>
            </a>
            <a class="nav-item" href="{{ route('user-payment') }}">
...
document.addEventListener('keydown', function (event) {
  ...
  <div class="row" id="welcome" style="background-color: #ebe8e8; min-height:80px;">
    ...
    <span class="ms-2 d-none d-sm-block user-item-desc" style="display: flex; align-items: center; margin-right:12px;">
        ...
        <span class="user-sub-title">Receptionist</span>
    </span>
</div>
</div>
<div>
