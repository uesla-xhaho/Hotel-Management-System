...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Menaxhimi i hoteleve</title>
    ...
    align-items: center;
    background: linear-gradient(180deg, #080155 1.76%, rgba(19, 13, 92, 0.61) 100%);
...
#login-container{
    ...
    height: 500px;
    display: grid;
    grid-template-rows: 150px 100px 70px 80px ;
    place-items: center;
    flex-shrink: 0;
    border-radius: 50px;
...
.header_tittle{
    ...
    <div id="maindiv">   
    <div class="container">
        <img src="images\Q9V8mgf3IXADJNEybIUTEDIEU3g.webp" style="width: 600px;
        height: 654px;" alt="images">
    </div>   

    <div class="container" id="login-container">
    <h1 class="header_tittle">LOG IN</h1>
